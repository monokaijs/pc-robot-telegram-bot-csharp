        ...
        private async Task StartBotAsync(CancellationToken cancellationToken)
        {
            try
            {
                await _botClient.SetMyCommandsAsync(new[]
                {
                    ...
                    new Telegram.Bot.Types.BotCommand { Command = "control", Description = "Control media playback and take screenshots" },
                    new Telegram.Bot.Types.BotCommand { Command = "screenshot", Description = "Capture a screenshot" },
                    new Telegram.Bot.Types.BotCommand { Command = "upload", Description = "Upload a file from the server: /upload <path>" },
                    new Telegram.Bot.Types.BotCommand { Command = "cancel_shutdown", Description = "Cancel a scheduled shutdown" },
                    ...
                    new Telegram.Bot.Types.BotCommand { Command = "secret", Description = "A protected command for allowed users and admin" }
                });
